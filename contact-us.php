...
var r=/^[a-zA-Z ]{2,30}$/;
if(!r.test(a)){
	document.getElementById("msg1").innerHTML="Please enter a valid name";
document.getElementById("fullname").value="";
          ...
          <form  method="post">
            <div class="form-group">
              ...
              <input type="text" onblur="chk()" name="fullname" class="form-control white_bg" id="fullname" required>
	      <span id="msg1"></span>	
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="number" name="contactno" class="form-control white_bg" id="phonenumber" required maxlength="10" pattern="[0-9]+">
            </div>
            <div class="form-group">
