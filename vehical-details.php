...
if(varDate <= today) {
alert("Invalid!");
window.location='http://localhost/carrental/vehical-details.php?vhid=1';
}
	...
	{
var date = document.getElementById("inputDate").value;
var varDate = document.getElementById("inputDate2").value;

if(varDate < date) {
alert("Invalid !!! Please enter the correct date");
window.location='http://localhost/carrental/vehical-details.php?vhid=1';
}
	  ...
	  <label>From Date:</label>
              <input type="date" onchange="call()" id="inputDate" class="form-control" name="fromdate" placeholder="From Date" required>
            </div>
            <div class="form-group">
              <label>To Date:</label>
              <input type="date" onchange="call2()" id="inputDate2" class="form-control" name="todate" placeholder="To Date" required>
            </div>
            <div class="form-group">
